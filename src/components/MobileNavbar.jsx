...
//               <div className="flex items-center px-4 py-2 border rounded-md bg-gray-100 dark:bg-gray-700">
//                 <Input
//                   type="text"
...
//                   <FiSearch size={20} className="text-gray-500 dark:text-gray-300 ml-0" />
//                 </Button>
//               </div>
//               <Link
//                 to="/create-event"
