...
const PaymentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (priceToPay === null || priceToPay < 1) {
      setModalMessage('The donation amount must be at least £1.00.');
      setIsModalOpen(true);
      return;
    }
            ...
            <form onSubmit={handleSubmit} className="w-full">
              <div className="mb-4">
                ...
                <Input
                  ...
                  step="0.01"
                  onBlur={(e) => {
                    if (event.price === 0 && (!e.target.value || parseFloat(e.target.value) < 1)) {
                      setModalMessage('For free events, the donation amount must be at least £1.00.');
                      setIsModalOpen(true);
                    }
                  }}                
                  />
