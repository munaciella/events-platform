export const PrivacyPolicy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to EventSphere.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to EventSphere, accessible from{' '}
            <a
              href="https://events-platform-murex.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://events-platform-murex.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile &#39application push notifications regarding updates
      ...
      <ul>
        <li>By email: francesco.vurchio82@gmail.com</li>
      </ul>
    </>
  );
};
